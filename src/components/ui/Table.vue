...
<template>
  <div class="w-full rounded-lg border border-neutral-200 bg-white">
    <!-- Loading State -->
    <div v-if="loading" class="flex items-center justify-center py-12">
      <div class="text-center">
        <div
          class="animate-spin rounded-full h-8 w-8 border-b-2 border-green-500 mx-auto mb-2"
        ></div>
    ...
    <div v-else :class="attrs.class">
      <table class="w-full bg-white border-collapse">
        <!-- Header -->
        <thead class="bg-neutral-50 border border-neutral-100">
          <tr>
            <th
        ...
        <tbody v-if="rows.length > 0">
          ...
          >
            ...
            <td
              v-if="$slots.actions"
              :class="[cellPadding, 'text-center relative overflow-visible']"
            >
