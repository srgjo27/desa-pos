...
const { stockToAdd, error, validateInput, handleStockInput, submitAddStock } =
  useAddStockModal(toRef(props, "isOpen"), toRef(props, "product"), (payload) =>
              ...
              <div class="px-6 py-5 space-y-5">
                <div class="bg-gray-50 border border-gray-200 rounded-md p-3">
                  ...
                  <p class="text-xs mt-2 text-gray-600">
                    Stok Saat Ini:
                    <span
                      class="font-mono bg-white px-1.5 py-0.5 border border-gray-200 rounded"
                      >{{ product?.stock }}</span
                    >
                    pc(s)
                  </p>
                ...
                <div>
                  <div class="flex items-end gap-2">
                    <button
                      type="button"
                      @click="stockToAdd = Math.max(1, stockToAdd - 1)"
                    ...
                    <Input
                      ...
                      :error="error"
                      @blur="validateInput"
                      @update:modelValue="handleStockInput"
                    />
                    <button
                      type="button"
                      @click="stockToAdd++"
                ...
                <div class="pt-2 flex justify-end gap-3 text-sm">
                  ...
                  <Button
                    ...
                    size="sm"
                    rounded="md"
                    :disabled="isLoading || stockToAdd < 1"
