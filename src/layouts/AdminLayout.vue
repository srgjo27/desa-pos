  ...
  <div class="min-h-screen bg-gray-50 flex flex-col font-sans bg-grid-pattern">
    ...
    <header class="bg-white border-b border-gray-100 px-6 sm:px-8 py-4 flex items-center justify-between shrink-0 sticky top-0 z-20">
       ...
       <div class="flex items-center gap-3">
         <button @click="handleLogout" class="px-4 py-2 bg-gray-50 hover:bg-red-50 hover:text-red-600 text-gray-600 rounded-sm text-sm font-medium transition-all focus:outline-none border border-gray-200 hover:border-red-200">
           Keluar
         </button>
       </div>
    </header>
    ...
    <div class="bg-white border-b border-gray-200 px-6 sm:px-8 flex items-center gap-8 overflow-x-auto custom-scrollbar shrink-0 sticky top-[73px] z-10">
       <button 
         ...
         class="py-3.5 text-sm font-medium transition-all whitespace-nowrap border-b-2 relative -mb-[1px]"
