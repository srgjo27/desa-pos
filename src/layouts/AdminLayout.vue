  ...
  <div class="min-h-screen bg-gray-50 flex flex-col font-sans bg-grid-pattern">
    ...
    >
      <div class="flex items-center gap-4">
        <div
          class="w-10 h-10 bg-green-50 rounded-sm flex items-center justify-center border border-green-100/50"
        ></div>
        <div>
          <h1
    ...
    <footer
      class="border-t border-gray-200 bg-white px-6 sm:px-8 py-4 text-center text-xs text-gray-500"
    >
      &copy; {{ currentYear }} DesaPOS. All rights reserved.
    </footer>
